...
a persistence unit "ExamenAPPPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenAPP\pom.xml":
...
artifact ("ExamenAPP.war") is already built. You can build
